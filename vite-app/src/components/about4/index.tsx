...
const About4: FC<About4Props> = (): ReactElement => {
  useEffect(() => {
    const animateImage = (element: HTMLElement): void => {
    ...
    elements.forEach((element) => animateImage(element as HTMLElement));
          ...
          <div className="col-lg-6 col-12">
            <div className="about-right">
              <div className="image new_img-animet">
                <img src={Ab1 as unknown as string} alt="" data-speed="0.8" />
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-12">
