...
const ProjectSection: FC<tSections> = ({ hClass }) => {
  useEffect(() => {
          ...
          <div className='col-lg-6 col-12'>
            <div className='section-top-content-s2'>
              ...
              <h3 className='poort-text poort-in-right'>
                My Recent Case Studies
              </h3>
              <p>
                I have done much more project. Most of them my clients love so
                much. I think you also like them.
              </p>
            </div>
          </div>
        </div>
            ...
            {PortfolioItems.slice(8, 12).map((project, Pky) => (
              <div className='col col-md-6 col-12' key={Pky}>
                <div className='protfolio-card'>
                  ...
                  <div className='text'>
                    <h2>
                      <Link href={`/project-single/${project.slug}`}>
                        {project.title}
                      </Link>
                    </h2>
