...
import { blogsData } from '@/utils/lib/constants';
  ...
  return (
    <section className='blog-section section-padding' id='blog'>
      <div className='container'>
        ...
        <div className='row'>
          {blogsData.slice(0, 2).map((Blogs, item) => (
            <div
              className='col-md-6 col-12 scroll-text-animation'
      ...
      <div className='shape'>
        <svg width='352' height='352' viewBox='0 0 352 352' fill='none'>
          <circle
            ...
            cy='176'
            r='176'
            fill='url(#paint0_radial_56_1808)'
            fillOpacity='0.4'
          />
          <defs>
            <radialGradient
              id='paint0_radial_56_1808'
              cx='0'
              cy='0'
              r='1'
