        ...
        <div className='row align-items-center align-items-md-start'>
          <div className='col-lg-4 col-md-6 col-12'>
            <div className='f-contact-widget widget'>
              ...
              <ul>
                <li>
                  <img src={Ficon as string} alt='' /> poort@gmail.com
                </li>
                <li>
                  <img src={Picon as string} alt='' />+ 8 (123) 123 - 456 - 789
                </li>
                <li>
                  <img src={Micon as string} alt='' />
          ...
          <div className='col-lg-4 col-md-6 col-12'>
            <div className='f-about-widget widget'>
              <Link to='/' className='logo'>
                <LogoWhite width='155' height='46' />
              </Link>
              <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ab
                ipsam suscipit minus cum eos porro totam, quam nobis quibusdam.{' '}
              </p>
      ...
      <div className='shape'>
        <svg width='471' height='540' viewBox='0 0 471 540' fill='none'>
          <circle
            ...
            cy='270'
            r='270'
            fill='url(#paint0_radial_56_1838)'
            fillOpacity='0.3'
          />
          <defs>
            <radialGradient
              id='paint0_radial_56_1838'
              cx='0'
              cy='0'
              r='1'
      ...
      <div className='shape-2'>
        <svg width='471' height='540' viewBox='0 0 471 540' fill='none'>
          <circle
            ...
            cy='270'
            r='270'
            fill='url(#paint0_radial_56_18381)'
            fillOpacity='0.3'
          />
          <defs>
            <radialGradient
              id='paint0_radial_56_18381'
              cx='0'
              cy='0'
              r='1'
              gradientUnits='userSpaceOnUse'
