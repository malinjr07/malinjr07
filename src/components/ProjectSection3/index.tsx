...
const ProjectSection3: FC<ProjectSection3Props> = ({ hclass = '' }) => {
  useEffect(() => {
  ...
  return (
    <section className={hclass} id="Portfolio">
      <div className="container">
        <div className="row">
          <div className="col-lg-6 col-12">
            <div className="section-top-content-s2">
              <h2 className="poort-text poort-in-right">Portfolio</h2>
              <h3 className="poort-text poort-in-right">My Recent Case Studies</h3>
              <p>I have done much more project. Most of them my clients love so much. I think you also like them.</p>
            </div>
          </div>
        </div>
        <div className="gallery-filters">
          <div className="row gallery-container">
            {PortfolioItems.slice(8, 12).map((project: Project) => (
              <div className="col col-md-6 col-12" key={project.id}>
                <div className="protfolio-card">
                  <div className="image">
                    <img 
                      className={project.category.includes('website') ? "thumbnail2" : "thumbnail"} 
                      src={project.image} 
                      alt={project.title} 
                    />
                  </div>
