...
export const metadata: Metadata = {
  ...
  description: `Welcome to my portfolio website! I'm Mosaddik Ali Maruf, a skilled Front-End Web Application Developer with a passion for crafting exceptional user experiences. With a solid track record of three years as a successful freelancer on Upwork and valuable experience working with mDoc, Uptechunt, and Flerr, I bring a wealth of expertise to the table.
